...
- Making logs older than 7 days not accessible through their Management API, forcing you instead to use an undocumented API through their `Search-UnifiedAuditLog` PowerShell cmdlet.
